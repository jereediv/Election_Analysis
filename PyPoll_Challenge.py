...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in counties_votes:
        ...
        if (cvotes > best_votes) and (county_percentage > best_percentage):
            best_votes = cvotes
    ...
    county_turnout = (
        f"--------------------------\n"
        f"Largest turnout: {best_county}\n"
        f"County percentage of votes: {best_percentage:.1f}%\n"
        f"Votes casted: {best_votes:,}\n"
        f"--------------------------\n")
